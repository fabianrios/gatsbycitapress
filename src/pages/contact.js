      ...
      <div className="internal-body">
        {intl.locale === 'en' ? (
          <div className="english-version">
            <p>
              <span class="inside-title">Contact:</span>
            ...
            <div className="center">
              <a class="btn btn-secondary btn-big" href="https://citapress.substack.com/"> Join our Newsletter! </a>
            </div>
            <hr />
            ...
            <br />
            <div className="center">
              <a class="btn btn-secondary btn-big" href="https://tinyletter.com/citapress" data-title="Books">Old TinyLetter (Archived)</a>
            </div>
          </div>
          ) : (
            <div className="spanish-version">
              <p>
                <span class="inside-title">Contacto:</span><span>Si tienes preguntas, sugerencias o flores, encuéntranos en <a href="https://github.com/citapress/citapress/">Github</a>, <a href="http://twitter.com/citapress">Twitter</a>, <a href="http://fb.com/citapress">Facebook </a> o <a href="http://instagram.com/cita.press">Instagram</a>, o escríbenos a <a href="mailto:info@citapress.org?Subject=Hello%20Hola%20Ciao">info@citapress.org</a>. </span>
              </p>
              <p>
              ...
              <div className="center">
                <a class="btn btn-secondary btn-big" href="https://citapress.substack.com/"> Suscríbete al Newsletter (sobre todo en inglés) </a>
              </div>
              <hr />
              ...
              <br />
              <div className="center">
                <a class="btn btn-secondary btn-big" href="https://tinyletter.com/citapress" data-title="Books">Antiguo Tinyletter (Archivado)</a>
              </div>
            </div>
          )}
      </div>
